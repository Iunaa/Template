...
export default function CardPricing({ data }) {
  ...
  return (
    <>
      {data.map((cur) => (
        // {const {title, subtitle, paragraph, popular, topics} = cur}
        <>
          <div className={`${pricingCardClass} ${cur.popular ? `${pricingCardClassPopular}` : ""}`}>
            ...
            {/* ${button("a", "#", popular ? "button--orange" : "button--white", "concat us")} */}
